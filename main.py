...
def main() -> None:
    ...
    # The Playwright runtime is started ONCE and lives for the entire process.
    # Each cycle only opens/closes a Chromium browser instance on this engine.
    # This prevents event-loop leaks if Chromium crashes mid-launch.
    with sync_playwright() as playwright_runtime:
        while True:
            ...
            try:
                with BrowserController(config, playwright=playwright_runtime) as browser:
